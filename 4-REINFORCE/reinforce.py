...
class Agent:
    def __init__(self, state_dim, action_size):
        ...
        self.optimizer = optim.Adam(self.p.parameters(), lr=self.lr)
...
def train():
    ...
    for episode in range(1, 100000 + 1):
        ...
        while not done:
            ...
            agent.rb.push(state, action, reward, nextstate, is_done) # Use 'terminated' for done flag in replay buffer for Bellman update
...
if __name__ == '__main__':
    ...
    # agent.q.load_state_dict(torch.load('model_pendulum_3000.pth'))
    print("\nStarting playback...")
    play()
