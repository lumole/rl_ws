...
class Rollout:
    def __init__(self,max_size=10000, gamma = 0.99):
    ...
    def get(self):
        states, actions, rewards, nextstates, dones = zip(*self.buffer)
...
class Agent:
    def __init__(self, state_dim, action_size):
        ...
        self.rb = Rollout(gamma = self.gamma)
...
def train():
    ...
    for episode in range(1, 100000 + 1):
        ...
        while not done:
            ...
            if agent.rb.buffer_size and (global_step%20 == 0 or is_done):
